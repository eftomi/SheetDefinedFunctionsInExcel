...
You can deactivate add-in by unselecting the check box next to SheetDefinedFunctions add-in in the same Add-Ins available box. [More about adding and removing Excel add-ins](Add or remove add-ins in Excel
